...
const allPermissions = {
    ...
    canAccessGuildHall: { label: "Access The Guild Hall", default: true },
    canManageSpecialMissions: { label: "Manage Special Missions", default: true },
    canSetDailyReminder: { label: "Set Daily Reminder", default: true },
