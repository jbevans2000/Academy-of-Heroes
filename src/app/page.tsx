...
export default function SplashPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col p-4 text-center text-white">
      ...
      {/* Content */}
      <main className="z-10 flex-grow flex flex-col items-center justify-between animate-in fade-in-50 duration-1000">
        ...
        {/* Footer placeholder to balance the layout */}
        <div className="w-full max-w-5xl py-4 invisible">
