                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                        ...
                        <div className="lg:col-span-9 relative" onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp}>
                            <div className="absolute top-2 left-2 z-20 flex gap-2">
                                <Button variant="outline" onClick={handleUnequipAll} className="bg-background/80"><ShirtIcon className="mr-2 h-4 w-4" />Unequip All</Button>
                                <Button onClick={handleSetCustomAvatar} disabled={isSettingAvatar} className="bg-background/80">
