                    ...
                    <Card className="shadow-lg">
                        ...
                        <CardContent className="pt-0 space-y-6">
                            <div className="prose max-w-none">
                                ...
                                <div className="my-6">
                                    <Image alt="Genetic Code" loading="lazy" width="1024" height="906" className="w-full h-auto" style={{ color: 'transparent' }} src="https://firebasestorage.googleapis.com/v0/b/academy-heroes-mziuf.firebasestorage.app/o/2025-09-07T03%3A35%3A07_84193%2FGenetic-Code-01-1-1024x906.png?alt=media&token=cc08dbec-2d8f-4440-8940-4a99a095c8cc" />
